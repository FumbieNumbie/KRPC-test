...
namespace KRPC_test
{
	public sealed class altPID
	{
		private double processVariable = 0;

		public altPID(double GainProportional, double GainIntegral = 0, double GainDerivative = 0, double OutputMax = 1, double OutputMin = 0)
		{
		...
		public double Update(TimeSpan timeSinceLastUpdate)
		{
